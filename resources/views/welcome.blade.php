...
<body
    ...
    class="antialiased bg-white text-slate-700 dark:bg-slate-950 dark:text-slate-300"
>
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <a href="{{ url('/') }}" class="flex items-center gap-3 shrink-0">
                    ...
                    <div class="leading-tight">
                        <p class="text-xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100">SIPERPUS</p>
                        <p class="text-[11px] text-slate-400 dark:text-slate-500 -mt-0.5">Sistem Informasi Perpustakaan</p>
                    </div>
                </a>

                {{-- Nav links --}}
                <nav class="hidden lg:flex items-center gap-10 text-[15px] font-medium">
                    <a href="#beranda" class="relative text-emerald-600 dark:text-emerald-400 pb-6 -mb-6">
                        Beranda
                        <span class="absolute left-0 right-0 -bottom-[1px] h-0.5 bg-emerald-600 dark:bg-emerald-400 rounded-full"></span>
                    </a>
                    <a href="#tentang" class="text-slate-600 hover:text-emerald-600 dark:text-slate-300 dark:hover:text-emerald-400 transition">Tentang</a>
                    <a href="#fitur" class="text-slate-600 hover:text-emerald-600 dark:text-slate-300 dark:hover:text-emerald-400 transition">Fitur</a>
                    <a href="#kontak" class="text-slate-600 hover:text-emerald-600 dark:text-slate-300 dark:hover:text-emerald-400 transition">Kontak</a>
                </nav>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="hidden md:flex items-center gap-3">
                        @if (Route::has('login'))
                            <a href="{{ route('login') }}"
                               class="inline-flex items-center gap-2 rounded-lg border border-emerald-600 text-emerald-600 font-semibold text-sm px-5 py-2.5 hover:bg-emerald-50 transition
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                               class="inline-flex items-center gap-2 rounded-lg bg-emerald-600 text-white font-semibold text-sm px-5 py-2.5 hover:bg-emerald-700 shadow-sm shadow-emerald-200 transition
                                      dark:bg-emerald-600 dark:shadow-none dark:hover:bg-emerald-700">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    {{-- ============ HERO ============ --}}
    <section id="beranda" class="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-sky-50 to-white
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
            <div class="grid lg:grid-cols-2 gap-10 items-center py-14 lg:py-0 lg:min-h-[560px]">
                ...
                <div class="relative z-10">
                    <span class="inline-flex items-center gap-2 rounded-full bg-emerald-100 text-emerald-700 text-sm font-semibold px-4 py-1.5
                                 dark:bg-emerald-500/10 dark:text-emerald-400">
                        📖 Selamat Datang
                    </span>

                    <h1 class="mt-6 text-4xl sm:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100 leading-[1.1]">
                        Sistem Informasi<br>
                        <span class="text-emerald-600 dark:text-emerald-400">Perpustakaan</span>
                    </h1>

                    <p class="mt-6 max-w-lg text-slate-500 dark:text-slate-400 text-[15px] leading-relaxed">
                    ...
                    <div class="mt-8 flex flex-wrap items-center gap-4">
                        <a href="{{ Route::has('dashboard') ? url('/dashboard') : '#' }}"
                           class="inline-flex items-center gap-2 rounded-lg bg-emerald-600 text-white font-semibold px-6 py-3 hover:bg-emerald-700 shadow-lg shadow-emerald-200 transition
                                  dark:bg-emerald-600 dark:shadow-none dark:hover:bg-emerald-700">
                        ...
                        <a href="#tentang"
                           class="inline-flex items-center gap-2 rounded-lg border border-emerald-600 text-emerald-600 font-semibold px-6 py-3 hover:bg-emerald-50 transition
                                  dark:border-emerald-500 dark:text-emerald-400 dark:hover:bg-emerald-500/10">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="relative lg:h-[560px] -mx-6 lg:mx-0">
                    <div class="relative h-72 sm:h-96 lg:h-full lg:absolute lg:inset-y-0 lg:right-0 lg:w-[130%] overflow-hidden lg:rounded-l-[2rem]">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-r from-sky-50 via-sky-50/10 to-transparent lg:w-1/3
                                    dark:from-slate-950 dark:via-slate-950/20"></div>
    ...
    {{-- ============ TENTANG ============ --}}
    <section id="tentang" class="py-20 lg:py-24 bg-white dark:bg-slate-950">
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
            <div class="grid lg:grid-cols-3 gap-8">
                <div class="lg:col-span-1">
                    <p class="text-emerald-600 dark:text-emerald-400 font-semibold text-sm tracking-wide uppercase">Tentang Sistem</p>
                    <h2 class="mt-2 text-3xl font-extrabold text-slate-900 dark:text-slate-100">
                        Perpustakaan yang Lebih Terorganisir
                    </h2>
                </div>
                <div class="lg:col-span-2 flex items-center">
                    <p class="text-slate-500 dark:text-slate-400 text-[15px] leading-relaxed">
                        SIPERPUS membantu admin, petugas, dan anggota perpustakaan mengelola
                        seluruh proses operasional — mulai dari pencatatan koleksi buku,
                        pendaftaran anggota, transaksi peminjaman dan pengembalian, hingga
                        pelaporan — dalam satu platform yang mudah digunakan.
                    </p>
                </div>
            </div>
        </div>
    ...
    {{-- ============ FITUR ============ --}}
    <section id="fitur" class="py-20 lg:py-28 bg-white dark:bg-slate-950">
        <div class="max-w-7xl mx-auto px-6 lg:px-10">

            <div class="text-center max-w-xl mx-auto mb-14">
                <p class="text-emerald-600 dark:text-emerald-400 font-semibold text-sm tracking-wide uppercase">Fitur Utama</p>
                <h2 class="mt-2 text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-slate-100">Fitur yang Tersedia</h2>
                <span class="block w-14 h-1 bg-emerald-600 dark:bg-emerald-500 rounded-full mx-auto mt-4"></span>
            </div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @php
                    $features = [
                        [
                            ...
                            'bg' => 'bg-emerald-100 dark:bg-emerald-500/10', 'fg' => 'text-emerald-600 dark:text-emerald-400',
                        ...
                        [
                            ...
                            'bg' => 'bg-amber-100 dark:bg-amber-500/10', 'fg' => 'text-amber-500 dark:text-amber-400',
                        ...
                        [
                            ...
                            'bg' => 'bg-rose-100 dark:bg-rose-500/10', 'fg' => 'text-rose-500 dark:text-rose-400',
                        ...
                        [
                            ...
                            'bg' => 'bg-violet-100 dark:bg-violet-500/10', 'fg' => 'text-violet-600 dark:text-violet-400',
                        ...
                        [
                            ...
                            'bg' => 'bg-teal-100 dark:bg-teal-500/10', 'fg' => 'text-teal-600 dark:text-teal-400',
                ...
                @foreach ($features as $f)
                    <div class="group rounded-2xl border border-slate-100 bg-white p-7 shadow-[0_10px_30px_-15px_rgba(15,23,42,0.15)]
                                hover:shadow-[0_15px_35px_-15px_rgba(37,99,235,0.25)] hover:-translate-y-1 transition duration-300
                                dark:border-slate-800 dark:bg-slate-900 dark:hover:shadow-[0_15px_35px_-15px_rgba(16,185,129,0.20)]">
                        ...
                        <h3 class="text-lg font-bold text-slate-900 dark:text-slate-100">{{ $f['title'] }}</h3>
    ...
    {{-- ============ FOOTER ============ --}}
    <footer id="kontak" class="bg-slate-900 text-slate-300 dark:bg-black dark:border-t dark:border-slate-800">
        <div class="max-w-7xl mx-auto px-6 lg:px-10 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-3 order-2 md:order-3">
                <a href="#" class="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center hover:bg-emerald-600 dark:hover:bg-emerald-600 transition">
