    ...
    <main class="flex-1 overflow-y-auto p-4 md:p-6 bg-slate-50 dark:bg-slate-950">
        <div class="max-w-6xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-semibold text-slate-900 dark:text-slate-100">Tambah Kategori</h1>
                    <p class="text-sm text-slate-500 dark:text-slate-400">Buat kategori baru untuk mengelompokkan buku</p>
                </div>
            </div>
            ...
            <div class="rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                <form action="{{ route('kategori.store') }}" method="POST" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" id="name_kategori" name="name_kategori" value="{{ old('name_kategori') }}" required autofocus
